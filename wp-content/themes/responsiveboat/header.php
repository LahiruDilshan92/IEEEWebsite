...
//    wp_register_style( 'sl_norm', get_template_directory_uri() . '/css/normalize.css' );
//    wp_register_style( 'sl_demo', get_template_directory_uri() . '/css/demo.css' );
    wp_register_style( 'jquicss', get_template_directory_uri(). '/css/jquery-ui.min.css' );
    wp_register_style( 'sl_compo', get_template_directory_uri(). '/css/component.css' );
    
//    wp_enqueue_style('sl_norm');
    wp_enqueue_style('jquicss');
    wp_enqueue_style('sl_compo');
...
//    wp_register_script( 'custom-script', plugins_url( '/js/custom-script.js', __FILE__ ), array( 'jquery', 'jquery-ui-core' ), '20120208', true );
    ...
    // Register the script like this for a theme:
      wp_register_script( 'jqui', get_template_directory_uri() . '/js/jquery-ui.min.js', array( 'jquery' ), '20120208', true );
    wp_register_script( 'modernizr', get_template_directory_uri() . '/js/modernizr.custom.js', array( 'jquery' ), '20120208', true );
    wp_register_script( 'classie', get_template_directory_uri() . '/js/classie.js', array( 'jquery' ), '20120208', true );
    wp_register_script( 'boxesFx', get_template_directory_uri() . '/js/boxesFx.js', array( 'jquery' ), '20120208', true );
 
    // For either a plugin or a theme, you can then enqueue the script:
    wp_enqueue_script( 'jqui' );
    wp_enqueue_script( 'modernizr' );
    wp_enqueue_script( 'classie' );
    wp_enqueue_script( 'boxesFx' );
}

slider_css();

//add_action( 'wp_enqueue_style', 'slider_css' );
...
<!--    <script type='text/javascript' src='http://localhost/ieeeuop/wp-content/themes/zerif-lite/js/modernizr.custom.js?ver=20120208'></script>-->
