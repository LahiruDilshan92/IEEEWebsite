...
<div class="container">
	...
	<?php
		...
		!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
					...
					echo '<div class="zerif-copyright-box">'.__('Powered by','zerif-lite').'<a class="zerif-copyright" href="https://www.facebook.com/uophackers/?fref=ts" rel="nofollow"> Hackers Club</a></div>';
