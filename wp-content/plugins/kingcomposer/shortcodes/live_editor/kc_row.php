<#
	...
	if( data === undefined )
		data = {};
	var attributes = [], classes = ['kc_row'], action = false, container_class = '', css_data = '', output = '', 
...
if( atts['video_bg_url'] === undefined )
{
	if( atts['parallax'] !== undefined )
	{
		...
		if( atts['parallax_background_size'] == 'yes' )
			attributes.push( 'data-kc-bgfull="true"' );
	}
}
...
if( container_class !== '' )
	output += '<div class="kc-row-container'+container_class+'">';
