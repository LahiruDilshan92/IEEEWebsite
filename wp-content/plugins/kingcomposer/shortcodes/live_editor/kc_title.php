...
var output = '', classes = ['kc_title'], wrp_class = [], attributes = [], type = 'h1', atts = ( data.atts !== undefined ) ? data.atts : {};
...
output = '<'+type+' '+attributes.join(' ')+'>'+kc.tools.base64.decode(atts['text'])+'</'+type+'>';
