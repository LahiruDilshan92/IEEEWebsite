...
if(!empty($description))
	$back_data .= '<p>'. do_shortcode( base64_decode($description) ) .'</p>';

if(!empty($show_button) && 'yes' === $show_button){
	$text_on_button = (!empty($text_on_button)) ? $text_on_button : __('Read more', 'kingcomposer');
